...
func decomposeTreadDumpLine(threadDumpLine string) (groups map[string]string, err error) {
	...
	//regex compile start OMIT
	r1 := regexp.MustCompile(THREAD_DESCRIPTOR1)
	//regex compile end OMIT
